...
Full breakdown: [`model_comparison.md`](model_comparison.md). \* Ollama's smoke 6/6 only counts non-empty answers — for real quality, look at `hallu_cite=8` and `lang_consistency=3/9`.
