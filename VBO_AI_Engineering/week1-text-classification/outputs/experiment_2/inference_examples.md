# Inference Examples — Experiment 2: BERT-base + 25K samples

**Model:** bert-base-uncased | **Device:** mps | **Date:** 2026-03-29 21:37
...
|---|----------|-----------|------------|----------|
| 1 | Positive | Positive | 99.82% | ✅ |
| 2 | Negative | Negative | 99.72% | ✅ |
| 3 | Ambiguous | Negative | 97.39% | 🔍 (subjective) |
| 4 | Positive | Positive | 99.83% | ✅ |
| 5 | Negative | Negative | 99.89% | ✅ |
| 6 | Tricky (Positive) | Positive | 56.16% | ✅ |
